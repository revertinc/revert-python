    ...
    def get_collections(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "ticket/collections"),
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(GetCollectionsResponse, _response.json())  # type: ignore
