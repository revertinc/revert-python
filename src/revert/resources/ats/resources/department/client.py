...
from .types.create_or_update_department_request import CreateOrUpdateDepartmentRequest
from .types.create_or_update_department_response import CreateOrUpdateDepartmentResponse
...
class DepartmentClient:
    ...
    def get_department(
        ...
        *,
        ...
        Parameters:
            - id: str. The unique `id` of the department.
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", f"ats/departments/{id}"),
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(GetDepartmentResponse, _response.json())  # type: ignore
    ...
    def get_departments(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "ats/departments"),
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(GetDepartmentsResponse, _response.json())  # type: ignore
        if _response.status_code == 401:
            raise UnAuthorizedError(pydantic.parse_obj_as(BaseError, _response.json()))  # type: ignore
        if _response.status_code == 500:
            raise InternalServerError(pydantic.parse_obj_as(BaseError, _response.json()))  # type: ignore
    ...
    def create_department(
        ...
        *,
        fields: typing.Optional[str] = None,
        request: CreateOrUpdateDepartmentRequest,
        x_revert_api_token: str,
        x_revert_t_id: str,
        x_api_version: typing.Optional[str] = None,
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(CreateOrUpdateDepartmentResponse, _response.json())  # type: ignore
        if _response.status_code == 401:
            raise UnAuthorizedError(pydantic.parse_obj_as(BaseError, _response.json()))  # type: ignore
        if _response.status_code == 500:
            raise InternalServerError(pydantic.parse_obj_as(BaseError, _response.json()))  # type: ignore
    ...
    def delete_department(
        ...
        *,
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(DeleteDepartmentResponse, _response.json())  # type: ignore
        if _response.status_code == 401:
            raise UnAuthorizedError(pydantic.parse_obj_as(BaseError, _response.json()))  # type: ignore
        if _response.status_code == 500:
            raise InternalServerError(pydantic.parse_obj_as(BaseError, _response.json()))  # type: ignore
