...
from .types.create_or_update_job_request import CreateOrUpdateJobRequest
from .types.create_or_update_job_response import CreateOrUpdateJobResponse
from .types.delete_job_response import DeleteJobResponse
...
class JobClient:
    ...
    def get_job(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", f"ats/jobs/{id}"),
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(GetJobResponse, _response.json())  # type: ignore
    ...
    def get_jobs(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "ats/jobs"),
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(GetJobsResponse, _response.json())  # type: ignore
        if _response.status_code == 401:
            raise UnAuthorizedError(pydantic.parse_obj_as(BaseError, _response.json()))  # type: ignore
        if _response.status_code == 500:
            raise InternalServerError(pydantic.parse_obj_as(BaseError, _response.json()))  # type: ignore
    ...
    def create_job(
        ...
        *,
        fields: typing.Optional[str] = None,
        request: CreateOrUpdateJobRequest,
        x_revert_api_token: str,
        x_revert_t_id: str,
        x_api_version: typing.Optional[str] = None,
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(CreateOrUpdateJobResponse, _response.json())  # type: ignore
        if _response.status_code == 401:
            raise UnAuthorizedError(pydantic.parse_obj_as(BaseError, _response.json()))  # type: ignore
        if _response.status_code == 500:
            raise InternalServerError(pydantic.parse_obj_as(BaseError, _response.json()))  # type: ignore
    ...
    def delete_job(
        ...
        *,
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(DeleteJobResponse, _response.json())  # type: ignore
        if _response.status_code == 401:
            raise UnAuthorizedError(pydantic.parse_obj_as(BaseError, _response.json()))  # type: ignore
        if _response.status_code == 500:
            raise InternalServerError(pydantic.parse_obj_as(BaseError, _response.json()))  # type: ignore
