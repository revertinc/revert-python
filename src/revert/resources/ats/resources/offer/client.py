...
from .types.create_or_update_offer_request import CreateOrUpdateOfferRequest
from .types.create_or_update_offer_response import CreateOrUpdateOfferResponse
from .types.delete_offer_response import DeleteOfferResponse
from .types.get_offer_response import GetOfferResponse
from .types.get_offers_response import GetOffersResponse
...
class OfferClient:
    ...
    def get_offer(
        ...
        *,
        ...
        Parameters:
            - id: str. The unique `id` of the offer.
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", f"ats/offers/{id}"),
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(GetOfferResponse, _response.json())  # type: ignore
    ...
    def get_offers(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "ats/offers"),
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(GetOffersResponse, _response.json())  # type: ignore
        if _response.status_code == 401:
            raise UnAuthorizedError(pydantic.parse_obj_as(BaseError, _response.json()))  # type: ignore
        if _response.status_code == 500:
            raise InternalServerError(pydantic.parse_obj_as(BaseError, _response.json()))  # type: ignore
    ...
    def create_offer(
        ...
        *,
        fields: typing.Optional[str] = None,
        request: CreateOrUpdateOfferRequest,
        x_revert_api_token: str,
        x_revert_t_id: str,
        x_api_version: typing.Optional[str] = None,
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(CreateOrUpdateOfferResponse, _response.json())  # type: ignore
        if _response.status_code == 401:
            raise UnAuthorizedError(pydantic.parse_obj_as(BaseError, _response.json()))  # type: ignore
        if _response.status_code == 500:
            raise InternalServerError(pydantic.parse_obj_as(BaseError, _response.json()))  # type: ignore
    ...
    def delete_offer(
        ...
        *,
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(DeleteOfferResponse, _response.json())  # type: ignore
        if _response.status_code == 401:
            raise UnAuthorizedError(pydantic.parse_obj_as(BaseError, _response.json()))  # type: ignore
        if _response.status_code == 500:
            raise InternalServerError(pydantic.parse_obj_as(BaseError, _response.json()))  # type: ignore
