...
from .types.search_tasks_response import SearchTasksResponse
...
class TaskClient:
    ...
    def get_task(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", f"crm/tasks/{id}"),
    ...
    def get_tasks(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "crm/tasks"),
    ...
    def search_tasks(
        ...
        *,
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(SearchTasksResponse, _response.json())  # type: ignore
        if _response.status_code == 401:
            raise UnAuthorizedError(pydantic.parse_obj_as(BaseError, _response.json()))  # type: ignore
        if _response.status_code == 500:
            raise InternalServerError(pydantic.parse_obj_as(BaseError, _response.json()))  # type: ignore
