...
from .types.create_or_update_event_request import CreateOrUpdateEventRequest
from .types.create_or_update_event_response import CreateOrUpdateEventResponse
from .types.delete_event_response import DeleteEventResponse
...
class EventClient:
    ...
    def delete_event(
        self, id: str, *, x_revert_api_token: str, x_revert_t_id: str, x_api_version: typing.Optional[str] = None
    ) -> DeleteEventResponse:
        """
